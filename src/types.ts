...
export type EnemyAbilityType = 'fixed-shield-per-turn' | 'attack-scaling'
export type CharacterAbilityKind = 'passive' | 'active'
export type CharacterAbilityType = 'passive-start-shield' | 'passive-max-hp' | 'passive-heal-per-turn' | 'active-heal' | 'active-shield' | 'active-damage'
