...
import { getLearningMistakes, getReviewMistakes, getTodayLearnedCount, isValidMistakePracticeCount, limitMistakeIds, loadBattleStore, resetDeckLearningMemory, saveBattleState, saveLearningBattleState, updateLearningMemory, updateReview } from './review'
...
describe('learning storage recovery', () => {
  ...
  it('ignores malformed learning records', async () => {
    ...
    const { loadLearningStore } = await import('./review')
