...
import { allReviewStats, clearBattleState, clearLearningBattleState, completeLearningDeck, getLearningMistakes, getReviewMistakes, getTodayLearnedCount, isValidMistakePracticeCount, limitMistakeIds, loadBattleStore, loadLearningStore, loadReviewStore, resetDeckLearningMemory, saveBattleState, saveLearningStore, saveReviewStore, startLearningSession, updateLearningMemory, updateReview } from '../accounts/local-progress'
...
export default function App() {
  ...
  return <main className="app-shell">
    ...
    {view === 'mistakes' && <MistakeBook review={review} learning={learningStore} library={library} initialPage={mistakeBookPage} onPractice={(maxCount) => startMistakePractice('practice', maxCount)} onLearning={(maxCount) => startMistakePractice('learning', maxCount)} onAll={(maxCount) => startMistakePractice('all', maxCount)} onBack={() => setView('menu')} />}
...
function MistakeBook({ review, learning, library, initialPage, onPractice, onLearning, onAll, onBack }: { review: ReviewStore; learning: LearningStore; library: CardRecord[]; initialPage: MistakeBookPage; onPractice: (maxCount?: number) => void; onLearning: (maxCount?: number) => void; onAll: (maxCount?: number) => void; onBack: () => void }) {
